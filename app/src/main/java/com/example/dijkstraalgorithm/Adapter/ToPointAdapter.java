...
public class ToPointAdapter extends RecyclerView.Adapter<ToPointAdapter.PointViewHolder>{
    ...
    public ToPointAdapter(ArrayList<String> pointArrayList, Context context) {
    ...
    @NonNull
    @Override
    public ToPointAdapter.PointViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.adapter_point, parent, false);
        return new ToPointAdapter.PointViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ToPointAdapter.PointViewHolder holder, int position) {
        ...
        void bind(final String point) {
            ...
            point_linear_layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    pageViewModel.setToInput(point);
